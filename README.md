...
The following Kubernetes versions are supported and work as we had tested against these versions in their respective branches. But note that other versions might work!
