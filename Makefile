...
.PHONY: validate
validate: validate-1.32 validate-1.33 validate-1.34

validate-1.32:
	KUBE_VERSION=1.32.8 $(MAKE) kubeconform

validate-1.33:
	KUBE_VERSION=1.33.4 $(MAKE) kubeconform

validate-1.34:
	KUBE_VERSION=1.34.0 $(MAKE) kubeconform
